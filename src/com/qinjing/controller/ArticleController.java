package com.qinjing.controller;
...
import com.qinjing.pojo.User;
import com.qinjing.service.impl.ArticleServiceImpl;
@Controller
@RequestMapping("/article")//当有/artitle命令时
public class ArticleController {
	@Autowired//装配文章数据库相关操作
	...
	public ModelAndView add(HttpServletRequest request, String title, String content) {
		...
		if (result.equals("success")) {
			view.addObject("msg", "发布成功了");
		} else {
			view.addObject("msg", "发布失败了");
		}
		return view;
	}
	...
	public ModelAndView update(HttpServletRequest request, String id, String title, String content) {
		...
		if(articleServiceImpl.update(article).equals("success")) {
			view.addObject("msg", "更新成功了");
		}
		view.addObject("msg", "更新失败了");
		return view;
	}
